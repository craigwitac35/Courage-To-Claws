...
export function ServicesGrid({ limit }: { limit?: number }) {
  ...
  return (
    <section className="section section--dark section--grid" aria-labelledby="services-title" id="services">
      <div className="container">
        ...
        <div className="services-grid services-grid--swipe services-grid--stagger reveal">
          {list.map((s) => (
